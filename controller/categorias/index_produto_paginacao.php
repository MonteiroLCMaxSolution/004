...
WHERE a.cod_categoria = '$categoria' AND b.status_produto like 'ATIVO' $and_CodEmpresa GROUP BY b.cod_produto LIMIT $inicio,$total_reg";
...
INNER JOIN produtos_empresa b ON a.cod_produto = b.cod_produto
WHERE a.cod_categoria = '$categoria'AND b.status_produto like 'ATIVO' $and_CodEmpresa GROUP BY b.cod_produto";
...
while ($row_categorias = $limite->fetch()){?>
    <div class="col-12 col-md-3">
     ...
     <?php } ?>
        ...
        <figure style="width:189px; height:179px" class="product-image-container">
          <a href="<?php echo $http;?>/view/dados-produto?codProduto=<?php echo $row_categorias->cod_produto;?>" class="product-image"> <img src="<?php echo $http; ?>/Painel/imagens/produtos/<?php echo $row_categorias->imagem;?>" alt="<?php echo 'Visualizado: '.$row_categorias->visualizado;?>" title="<?php echo 'Visualizado: '.$row_categorias->visualizado;?>"> 
        </a> 
          <a href="<?php echo $http;?>/ajax/product-quick-view.php?codProduto=<?php echo $row_categorias->cod_produto;?>" class="btn-quickview">Olhada Rápida</a> 
      </figure>
