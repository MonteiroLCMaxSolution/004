...
<div class="container">
  <div class="row">
    ...
    <div class="col-lg-12">
      <h2>Meus Dados</h2>
      <form name="form1" action="<?php echo $http;?>/model/cliente/cliente.php?grv='1'" method="post">
        <div class="container">
          <div class="row">
            <div class="col-lg-2">
              <label>Código</label>
            ...
            <div class="col-lg-3">
              <label>Fone</label>
              <input name="fone" class="form-control" onkeypress="return mask(event, this, '(##) ####-####')" maxlength="14" placeholder=" (DDD) 0000-0000">
            </div>
             <div class="col-lg-3">
              <label>Celular</label>
            ...
            <div class="col-lg-3">
              <label>CEP</label>
              <input name="CEP" class="form-control" onkeypress="return mask(event, this, '#####-###')" maxlength="9" placeholder="" id="cep" onkeyup="pesquisacep(this.value);" required>
            </div>
            <div class="col-lg-2">
              <label>UF</label>
        ...
        <option value=""></option>
            ...
            <div class="col-lg-4">
              <div class="col-lg-12">
                <label>Login</label>
                <input name="login" class="form-control" required="required">
              </div>
              <div class="col-lg-12">
                <label>Senha</label>
                <input name="senha" class="form-control" required="required">
              </div>
              <div class="col-lg-12">
