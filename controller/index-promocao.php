...
<HR/>
<h2 class="title text-center">Promoção</h2>
...
while ($row_listar_produtos = $consulta_promocao->fetch()){
    ...
    <div class="col-6 col-md-4 col-lg-3">
        <div class="product">
                ...
                <div class="price-box" style="height:70px">
                    <span class="product-price">
                       <?php if(!empty($idCliente)){
                        if ($row_listar_produtos->valor_promocao > 0 ){?>
                           <span class="old-price">De:
                               <?php  echo 'R$ '.number_format($row_listar_produtos->valor_atual,2,',','.');?>
                           </span> <BR/>
                       ...
                       <?php }else{?>
                           <span class="product-price">
                               <?php  echo 'R$ ';?>
                               <input name="valorProduto" readonly="readonly" style="border: 0px; width:60px;" value="<?php  echo number_format($row_listar_produtos->valor_atual,2,',','.');?>" />
                           </span>
                       <?php }
                   }?>
               </span>
           ...
           <div class="product-action">
             ...
             <?php }else { ?>
                 <a href="?pg=login_cliente&codProduto=<?php echo $row_listar_produtos->cod_produto;?>" class="paction add-cart" title="Clique aqui para logar"> <span>Ver Preços</span> </a>
             <?php } ?>   
