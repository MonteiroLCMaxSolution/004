...
<body>
    <div class="page-wrapper">
       <?php include_once ('header.php'); ?>
        ...
        <main class="main">
            <div class="container">
               ...
               <?php include_once ('controller/index-slider.php'); ?>

               <?php //include_once ('controller/info-box.php'); ?>
               
               <?php include_once ('controller/index-produtos.php'); ?>
     ...
     <!------------------------------------------------------------->           
	  ...
	  <!-------------------------------------------------------------> 
               <?php include_once ('controller/index-flyer.php'); ?>
   ...
   <?php if(empty($_SESSION['id_do_cliente'])){
       //include_once ("controller/newsletter/newsletter.php"); 
   }?>
