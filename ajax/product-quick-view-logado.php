...
<div class="row">
    <div class="col-lg-9 offset-lg-3">
        <h2 class="title text-center">Como Comprar</h2>
        <div class="row">
...
<div class="product-single-container product-single-default product-quick-view container">
  ...
  $SQL_dadosProduto = "SELECT a.id,b.cod_subcategoria, a.cod_empresa,b.cod_marca as marca, a.id,ifnull(a.minimo_produto_venda,0) as minimo_produto_venda,a.minimo_produto_venda, a.cod_produto, a.valor_prazo as valorProduto, a.unidade, b.nome_produto, c.valor_promocao, b.descricao, d.nome_marca,ifnull(a.estoque_disponivel,0) AS estoque_disponivel
...
<script src="<?php echo $http;?>/js/product-quick-view.js"></script>
        </div>
    </div>
</div>
